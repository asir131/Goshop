...
const DisplayCartItem = ({close}) => {
  ...
  return (
    <section className='bg-neutral-900/70  fixed top-0 bottom-0 right-0 left-0  z-5'>
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto z-5'>
